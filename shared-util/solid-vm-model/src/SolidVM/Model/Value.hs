...
valEquals ct lhs rhs = case (lhs, rhs) of
  ...
  (SContract _ a1, SContract _ a2) ->  if ((CC._vmVersion ct == "svm3.0") || (CC._vmVersion ct == "svm3.1")) then (a1 == a2) else todo "unsupported type combination in valEquals: " (lhs, rhs)
