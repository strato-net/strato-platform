...
data StoragePath = Null
                 | Field B.ByteString StoragePath
                 | MapIndex IndexType StoragePath
                 | ArrayIndex Int StoragePath
...
unparsePath = B.concat . go
  where go :: StoragePath -> [B.ByteString]
        go Null = []
...
constructFromNothing Null = BasicValue
