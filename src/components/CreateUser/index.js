  ...
  render() {
    return (
      <div className="smd-pad-16">
        <Button onClick={()=>{mixpanelWrapper.track('create_user_open_click'); this.props.openOverlay()}} className="pt-intent-primary pt-icon-add"
                text="Create User"/>
        <Dialog
          iconName="inbox"
          ...
          <form>
            ...
            <div className="pt-dialog-footer">
              <div className="pt-dialog-footer-actions">
                <Button text="Cancel" onClick={()=>{mixpanelWrapper.track('create_user_close_click');this.props.closeOverlay()}}/>
                <Button
