export const env = {
  ...
  CIRRUS_URL: window.CIRRUS_URL && window.CIRRUS_URL !== '__CIRRUS_URL__' ? window.CIRRUS_URL : 'http://stratodev.blockapps.net/cirrus/search',
  APEX_URL: window.APEX_URL && window.APEX_URL !== '__APEX_URL__' ? window.APEX_URL : 'http://localhost:3001',
  ...
  SOCKET_SERVER: window.APEX_URL && window.APEX_URL !== '__APEX_URL__' ? `ws://${(new URL(window.APEX_URL)).host}/` : 'ws://localhost'
};
