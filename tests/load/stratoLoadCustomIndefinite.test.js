...
describe('Strato Load Test', function() {
  ...
  it('Upload contracts', function * () {
   ...
   /*
    ...
    const fs = require('fs');
    fs.appendFile("graph_PERFORMANCE_multinode_strato_load_custom_indefinite.csv", data, function(err) {
        if(err) {
            return console.log(err);
        }

        console.log("graph_PERFORMANCE_multinode_strato_load_custom_indefinite.csv data has been sent!");
        });
    fs.appendFile("graph_PERFORMANCE_multinode_strato_load_custom_indefinite.csv", "\n", function(err) {
        if(err) {
            return console.log(err);
        }
    */
