...
scp "$1" mercata-testnet-buildtest:/datadrive/testnet/strato-getting-started/docker-compose.yml && ssh mercata-testnet-buildtest "cd /datadrive/testnet/strato-getting-started && sudo ./strato --pull && sudo ./strato --wipe"
...
ssh mercata-testnet-buildtest "cd /datadrive/testnet/strato-getting-started && sudo ./strato-run.sh"
