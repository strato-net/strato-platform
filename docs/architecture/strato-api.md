...
For full swagger documentation of the STRATO API, with an interactive Try it Out interface, please visit [https://app.testnet.strato.nexus/docs/](https://app.testnet.strato.nexus/docs/) or visit `/docs` on your preferred node.
