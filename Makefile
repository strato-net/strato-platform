...
build_buildbase:
	mkdir -p $(TMPDIR)
	blockapps-haskell/pull_solc.sh 0.4.25 $(TMPDIR)/solc-0.4.25 $(TMPDIR)/license
	blockapps-haskell/pull_solc.sh 0.5.0 $(TMPDIR)/solc-0.5.0 $(TMPDIR)/license
	ln -f $(TMPDIR)/solc-0.4.25 $(TMPDIR)/solc
