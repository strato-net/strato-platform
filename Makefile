...
docker-compose:
	...
	sed -e 's|<REPO_URL>|'"${REPO_URL}"'|g' -e 's|<VERSION>|'"${VERSION}"'|g' docker-compose.validator.tpl.yml > docker-compose.validator.push.yml
	...
	awk '/build: ./{getline} 1' docker-compose.validator.push.yml > docker-compose.validator.yml
