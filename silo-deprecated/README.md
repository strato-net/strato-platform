...
./bootstrap <branch>
```
After this is complete, you will have the Haskell Stack and Docker installed.

Once this is done you may fetch the entire `silo` repo with
```
git clone https://github.com/blockapps/silo
```
