...
import "compat/CDPVault.sol";
import "compat/Token.sol";
import "compat/TokenFactory.sol";
import "compat/PriceOracle.sol";
import "./CDPRegistry.sol";
import "compat/FeeCollector.sol";
...
contract CDPEngine is Ownable {
    ...
    */
    ...
    mapping(address => JuniorNote) public  juniorNotes;
