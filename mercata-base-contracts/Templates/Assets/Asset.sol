...
abstract contract Asset {
    ...
    constructor() {
        ...
        ownerOrganizationalUnit = Certificate(account(address(c), "main")).organizationalUnit();
    ...
    modifier requireOwner(string action) {
        ...
        require(org == ownerOrganization, err);
        string orgUnit = Certificate(account(address(c), "main")).organization();
        require(orgUnit == ownerOrganizationalUnit, err);
    ...
    function transferOwnership(string _newOwnerOrganization, string _newOwnerCommonName) public requireOwner("Ownership transfer") {
        ...
        ownerOrganizationalUnit = _newOwnerOrganizationalUnit;
