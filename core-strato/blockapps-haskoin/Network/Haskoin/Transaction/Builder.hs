...
import Data.Conduit (ConduitM, Void, await, (.|), runConduitPure)
...
chooseCoins target kbfee continue coins =
    runConduitPure $ sourceList coins .| chooseCoinsSink target kbfee continue
...
chooseMSCoins target kbfee ms continue coins =
    runConduitPure $ sourceList coins .| chooseMSCoinsSink target kbfee ms continue
