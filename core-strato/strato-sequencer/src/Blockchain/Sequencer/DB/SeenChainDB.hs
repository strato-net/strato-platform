...
lookupSeenChain chainId = isJust . join . fmap _chainInfo <$> getChainIdEntry chainId
...
insertSeenChain chainId cInfo = do
  ...
  repsertChainIdEntry_ chainId $ return . maybe (chainIdEntryWithChainInfo cInfo) (chainInfo .~ Just cInfo)
