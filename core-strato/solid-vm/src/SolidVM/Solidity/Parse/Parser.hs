...
import           SolidVM.Solidity.Xabi              (Xabi(..), xabiTypes)
import           SolidVM.Solidity.Xabi.Def
--import           SolidVM.Solidity.Xabi.VarDef       (VarType(..))
...
xabiMerge x y =
  Xabi{
    ...
    xabiConstants = xabiConstants x `Map.union` xabiConstants y,
