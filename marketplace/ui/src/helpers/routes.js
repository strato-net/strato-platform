...
export default {
  ...
  MarketplaceProductList: { label: "Marketplace Product List", url: "/category/:category", },
  MarketplaceProductDetail: { label: "Marketplace Product Detail", url: "/productList/:address", },
  ...
  BoughtOrderDetails: { label: "Bought Order Detail", url: "/bought-orders/:id", },
  SoldOrderItemDetail: { label: "Order Item Detail", url: "/sold-orders-details/:id", },
  BoughtOrderItemDetail: { label: "Order Item Detail", url: "/bought-orders-details/:id", },
  OrderItemEventsList: { label: "Order Item Event List", url: "/orders/events/:itemId", },
  ...
  InventoryEventDetail: { label: "Event Detail", url: "/inventories/events/:inventoryId/:eventTypeId", },
  ...
  MyAssets: { label: "My Assets", url: "/myAssets" }
};
