...
export default {
  ...
  StakeableProductDetail: { label: "Product Detail", url: '/:productName/:address'},
  EthstProductDetail: { label: 'ETHST Product Detail', url: '/:productName/:address' },
  WbtcstProductDetail: { label: 'WBTCST Product Detail', url: '/:productName/:address' },
