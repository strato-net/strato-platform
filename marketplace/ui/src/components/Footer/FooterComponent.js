    ...
    social: [
        {
          ...
          },
          {
            ...
            icon: (props) => (
              <svg width="24px" height="24px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor" {...props}>
      ...
      <footer className="bg-[#131889]" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
            <p className="text-xs leading-5 text-white">&copy; 2024 BlockApps, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
