...
const EventType = () => {
  ...
  const naviroute = routes.EventTypeDetail.url;
  ...
  const { 
    ...
    isOwnershipeventTypeTransferring,
    iseventTypeUpdating,
    message,
    success,
  ...
  for (const value in Object.values(eventTypes)) {
    if (eventTypes[value].ownerOrganizationalUnit === '') {
      eventTypes[value].ownerOrganizationalUnit = 'N/A';
    }
  }
  ...
  return (
    <div>
      ...
      {isCreateModalOpen && <CreateModal
        ...
        dispatch={dispatch}
        actions={actions}
        isCreateSubmitting={isCreateEventTypeSubmitting}
      ...
      {isUpdateModalOpen && <UpdateModal
        ...
        dispatch={dispatch}
        actions={actions}
        isUpdating={iseventTypeUpdating}
        debouncedSearchTerm={debouncedSearchTerm}
      ...
      {isTransferOwnershipModalOpen && <TransferOwnershipModal
        ...
        dispatch={dispatch}
        actions={actions}
        isTransferring={isOwnershipeventTypeTransferring}
      />}
