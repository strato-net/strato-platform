...
const Category = () => {
  ...
  const naviroute = routes.CategoryDetail.url;
  ...
  const { 
    ...
    isOwnershipcategoryTransferring,
    iscategoryUpdating,
    message,
    success,
  ...
  for (const value in Object.values(categorys)) {
    if (categorys[value].ownerOrganizationalUnit === '') {
      categorys[value].ownerOrganizationalUnit = 'N/A';
    }
  }
  ...
  return (
    <div>
      ...
      {isCreateModalOpen && <CreateModal
        ...
        dispatch={dispatch}
        actions={actions}
        isCreateSubmitting={isCreateCategorySubmitting}
      ...
      {isTransferOwnershipModalOpen && <TransferOwnershipModal
        ...
        dispatch={dispatch}
        actions={actions}
        isTransferring={isOwnershipcategoryTransferring}
      />}
