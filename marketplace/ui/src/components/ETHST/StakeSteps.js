  ...
  return (
    <div className="bg-[#f3f4f6] p-4 rounded-md mx-16">
      <h2 className="text-center text-xl font-semibold mb-6">
        How to stake {AssteName} in 4 simple steps
      </h2>
        ...
        <div className="flex flex-col items-center z-10 relative md:w-1/4">
          ...
          <div className="flex flex-col justify-start items-center h-28 mt-3">
            ...
            <p
              ...
              style={{ color: '#4b5563' }}
            >
              Stake your {AssteName} tokens and begin earning daily rewards in the
        ...
        <div className="flex flex-col items-center z-10 relative md:w-1/4">
          ...
          <div className="flex flex-col justify-start items-center h-28 mt-3">
            ...
            <p
              ...
              style={{ color: '#4b5563' }}
            >
              Borrow (interest-free for a limited time!) USDST against your staked {AssteName}.
            </p>
          </div>
        </div>
      </div>
