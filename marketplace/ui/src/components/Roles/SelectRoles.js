    ...
    <div>
      ...
      <div className="flex justify-center mt-32">
        <Card className="w-[28rem]" bodyStyle={{ padding: "0" }}>
          <h1 className="text-center text-black text-xl font-bold mt-6">Select Role</h1>
          <Divider />
          <p className="text-left ml-6">Please select the role to access the application</p>
