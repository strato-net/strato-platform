...
import New_CartComponent from "./New_CartComponent";
import New_ResponsiveCart from "./New_ResponsiveCart";
  
  const { Title, Text } = Typography;
  
  const New_Checkout = ({ user }) => {
...
,
 ...
 <div className="hidden  lg:block"><New_CartComponent columns={columns} data={e.value} /> </div> <div className="lg:hidden"><div className="flex gap-3 flex-col"><New_ResponsiveCart data={e.value}/></div></div></>)
            }
          </div>
        )}
        <ConfirmOrderModel
