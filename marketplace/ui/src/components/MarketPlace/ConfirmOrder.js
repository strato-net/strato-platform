                  ...
                  <div id="address-list-block-div" className="mt-4">
                    {isAddingShippingAddress || isLoadingUserAddresses || isLoadingStripeStatus ?
                      ...
                      userAddresses.length !== 0 ?
                        <div id="address-list" className="address-list grid grid-rows-2 sm:grid-rows-1 grid-flow-col gap-4 lg:flex  lg:flex-wrap overflow-x-auto lg:overflow-y-auto hide-Scroll lg:gap-x-6 lg:gap-y-[20px] pt-4 h-[50%] lg:h-[44vh]">
                          {
