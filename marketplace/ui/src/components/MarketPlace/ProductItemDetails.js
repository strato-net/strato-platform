        ...
        case "Clothing":
            return (
                <Space direction="vertical" className="py-[15px] px-[14px] w-full sm:w-[388px] md:w-[417px] border border-[#E9E9E9] rounded-md">
                    ...
                    <Space className="flex justify-between">
                        <DescTitle text="Size" />
                        <Text className="text-[13px] text-[#202020] font-medium">{itemData?.size}</Text>
                    </Space>
                    <Space className="flex justify-between">
                    ...
                    <Space className="flex justify-between">
                        <DescTitle text="SKU" />
                        <Text className="text-[13px] text-[#202020] font-medium">{itemData?.skuNumber}</Text>
                    </Space>
                </Space>)
        case "Collectibles":
            return (
            ...
            return (
                <Space direction="vertical" className="py-[15px] px-[14px] w-full sm:w-[388px] md:w-[417px] border border-[#E9E9E9] rounded-md">
                    ...
                    <Space className="flex justify-between">
                        ...
                        <Text className="text-[13px] text-[#202020] font-medium">{itemData?.leastSellableUnits}</Text>
                    </Space>
                </Space>)
        case "Membership":
            return (
