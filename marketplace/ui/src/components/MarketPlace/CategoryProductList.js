      ...
      <div className="flex pt-4 mx-14 mt-[60px] md:mt-4 ">
        ...
        <div className="mb-12 w-full">
          ...
          {isLoading ?
            ...
            <div>
              {marketplaceList?.length > 0 ? (
                <div className={`mt-[61px] md:mt-4 mb-8 flex w-full md:grid flex-col items-center ${desktopOpenFilter ? "grid-cols-1 gap-4 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 lg:gap-14 xl:gap-x-10 2xl:gap-x-20" : " sm:grid-cols-1 gap-4 md:grid-cols-2 md:gap-14 lg:grid-cols-3 lg:gap-16 xl:grid-cols-4"}`} id="product-list">
