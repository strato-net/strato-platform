...
import { inventoryArgs, inventoryArgsWithNoSN } from './factories/inventory'
...
describe('OrderLineItem End-To-End Tests', function () {
  ...
  it('Create an OrderLineItem (Without Serial Numbers)', async () => {
    const createProductArgs = {
      ...productArgs(util.uid()),
    }
    ...
    // create order line item
    const createOrderLineItemsArgs=factory.getCreateOrderLineItemsArgs(orderId,orderAddress,orderLineId)
