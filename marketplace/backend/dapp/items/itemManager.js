...
function bind(user, _contract, options) {
    ...
    contract.getRawMaterial = async (args, options) => rawMaterialJs.get(user, args, options);
    contract.getRawMaterials = async (args, options) => rawMaterialJs.getAll(user, args, options);
    return contract
}
