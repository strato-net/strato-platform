...
/** 
 * Bind an existing CarbonDAO contract to a new user token. Useful for having multiple users test
 * the same contract.
...
async function getAll(admin, args = {}, options) {
    const inventories = await searchAllWithQueryArgs(constants.assetTableName, { ...args, category: `['CarbonDAO']` }, options, admin);
