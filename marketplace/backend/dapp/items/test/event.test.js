...
import factory from '../factory/event.factory';
...
describe('Event', function () {
    ...
    const factoryArgs = () => ({ ...(factory.getEventArgs(util.uid())) });
    ...
    it('Create Event - 201', async () => {
        ...
        contract = await eventJs.uploadContract(globalAdmin, args, newOptions);
