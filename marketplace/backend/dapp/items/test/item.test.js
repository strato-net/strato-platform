...
import factory from '/dapp/items/factory/item.factory';
...
/**
 * Test out functionality of Item
 */
...
//     const factoryArgs = () => ({ ...(factory.getItemArgs(util.uid())) });
...
//         contract = await itemJs.uploadContract(globalAdmin, args.itemArgs, newOptions);
//         const state = await contract.get();

//         delete args.itemArgs.uniqueProductCode
//         delete args.itemArgs.rawMaterialProductName
//         delete args.itemArgs.rawMaterialSerialNumber
//         delete args.itemArgs.rawMaterialProductId
