...
import factory from '../factory/category.factory';
...
describe('Category', function() {
    ...
    it('should upload Category smart contract', async () => {
    const args=factoryArgs(globalAdmin)
    contract=await categoryJS.uploadContract(globalAdmin,args,newOptions);
