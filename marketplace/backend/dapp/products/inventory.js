...
async function getAll(admin, args = {}, defaultOptions) {
    ...
    if (isTrendingSearch) {
        ...
        sales = await saleJs.getAll(admin, { range, isOpen: true, order: 'block_timestamp.desc', offset: '0', gtField: args.gtField, gtValue: args.gtValue, creator: process.env.SELLER }, options);
