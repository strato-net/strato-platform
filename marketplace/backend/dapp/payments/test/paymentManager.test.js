...
describe('Payment Manager', function() {
    ...
    const updateFactoryArgs = (user,address) => ({...(factory.getUpdatePaymentArgs(util.uid(),address))})
    ...
    before(async () => {
        ...
        contract = await paymentManagerJs.uploadContract(globalAdmin, args, newOptions);
