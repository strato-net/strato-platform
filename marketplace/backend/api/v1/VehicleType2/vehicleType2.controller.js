...
class VehicleType2Controller {
  static async getAll(req, res, next) {
    try {
      const { dapp, query } = req

      const vehicles = await dapp.getVehicleType2({ ...query })
  ...
  static async create(req, res, next) {
    try {
      ...
      VehicleType2Controller.validateCreateVehicleArgs(body)

      const result = await dapp.createVehicleType2(body)
...
export default VehicleType2Controller;
