...
rest.createContract = async (user, contract, options) =>
  enhancedException(async () => createContractImpl(user, contract, options));
...
export { rest, util, importer, fsUtil, assert };
