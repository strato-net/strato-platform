...
export const USERMEBERSHIP_STATUS = {}
USERMEBERSHIP_STATUS[USERMEBERSHIP_STATUS['NEW'] = 1] = 'NEW';
USERMEBERSHIP_STATUS[USERMEBERSHIP_STATUS['ACCEPTED'] = 2] = 'ACCEPTED';
USERMEBERSHIP_STATUS[USERMEBERSHIP_STATUS['REJECTED'] = 3] = 'REJECTED';
Object.freeze(USERMEBERSHIP_STATUS)

export const ROLE = {}
ROLE[ROLE['ADMIN'] = 1] = 'ADMIN';
ROLE[ROLE['TRADING_ENTITY'] = 2] = 'TRADING_ENTITY';
ROLE[ROLE['CERTIFIER'] = 3] = 'CERTIFIER';
Object.freeze(ROLE)
