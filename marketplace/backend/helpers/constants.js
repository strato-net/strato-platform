...
export default {
  ...
  attachSalesAndImagesAndFiles:
    "*,BlockApps-Mercata-Asset-files(*),BlockApps-Mercata-Asset-images(*),BlockApps-Mercata-Asset-fileNames(*),BlockApps-Mercata-Sale!BlockApps-Mercata-Sale_BlockApps-Mercata-Asset_fk(*,BlockApps-Mercata-Sale-paymentProviders(*))",
...
export const calculateAveragePrice = (records) => {
  return (
    records.reduce((sum, record) => sum + record.price, 0) / records.length
  );
};
