...
!!! tip "Reference Implementation"
    The **mercata** app (in `app/` folder) is the complete reference implementation showing how to build apps on STRATO.
...
**Example: mercata app** (`app/backend/`)
...
- **mercata app** - `strato-platform/app/` folder
