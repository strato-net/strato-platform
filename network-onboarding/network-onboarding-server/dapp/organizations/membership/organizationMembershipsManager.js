...
const contractName = 'OrganizationMembershipsManager'
const contractFilename = `${util.cwd}/dapp/organizations/membership/contracts/OrganizationMembershipsManager.sol`
