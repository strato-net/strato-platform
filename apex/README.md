...
2. cd `apex/api`
2. `stratoRoot=http://localhost:8888/strato-api/eth/v1.2/ blocRoot=http://localhost:3333/bloc/v2.2 postgresPort:5433 npm run start:dev`
...
2. cd `apex/api`
3. `sudo NODE_ENV=development OAUTH_ENABLED=true STRATO_HOST=http://localhost:3333 BLOC_HOST=http://localhost:8888 VAULT_HOST=http://localhost:8484 POSTGREST_HOST=http://localhost:3434 POSTGRES_PORT=5433 ./run-tests.sh`
