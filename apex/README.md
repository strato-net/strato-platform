...
2. cd `apex/api`
3. `stratoRoot=http://localhost/strato-api/eth/v1.2 NODE_HOST=localhost NODE_ENV=development SINGLE_NODE=true ./node_modules/mocha/bin/mocha $NODE_DEBUG_OPTION --config=config-local.yaml test/`
