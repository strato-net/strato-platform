import { OPEN_ATTEST_MODAL, CLOSE_ATTEST_MODAL, ATTEST_DOCUMENT_SUCCESS, ATTEST_DOCUMENT_FAILURE, RESET_ERROR, ATTEST_DOCUMENT_REQUEST, USERNAME_FORM_CHANGE } from "./attest.action";
