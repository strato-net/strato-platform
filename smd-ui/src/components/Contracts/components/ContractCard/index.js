                  ...
                  <div className="row" style={{ marginTop: '10px', marginBottom: '10px' }}>
                    ...
                    <div className="col-sm-6 text-right">
                      <Button 
                        ...
                        disabled={!this.props.instancePagination || !this.props.instancePagination[name] || !this.props.instancePagination[name].hasMore}
                      >
                        Next
                      </Button>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-sm-12 text-center">
                      <small className="pt-text-muted">
                        ...
                        {this.props.instancePagination && this.props.instancePagination[name] && this.props.instancePagination[name].hasMore && " (more available)"}
                      </small>
                    </div>
                  </div>
                </Collapse>
