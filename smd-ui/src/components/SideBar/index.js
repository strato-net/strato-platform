  ...
  render() {
    const navLinksData = [
      ...
      /*      { path: '/code_editor', label: 'Contract Editor', id: 'code_editor', icon: "fa-code" } 
        ...
        This is just to remove "Access" to the Contract Editor. I do not believe we need to delete the entire page due to needing it to for debugging purposes. 
*/
    ];
    ...
    return (
      <aside>
        <div className="menu">
          {navLinksData.map((data) => (
            <NavLink
              ...
              onClick={() => {
                mixpanelWrapper.track("nav_link_" + data.id + "_click");
              }}
            >
          ...
          {isS3Available() && (
            <NavLink
              ...
              activeClassName="active-menu-item"
              onClick={() => {
                mixpanelWrapper.track("nav_link_external_storage_click");
              }}
            >
        ...
        <div className="smd-sidebar-logo">
          ...
          >
            <img src={logo} width="120" alt="Blockapps Logo" />
          </a>
        </div>
      </aside>
    );
