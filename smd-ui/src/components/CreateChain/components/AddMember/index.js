...
class AddMember extends Component {
  ...
  submit = () => {
    let data = {
      username: env.OAUTH_ENABLED ? this.props.initialValues.from : this.state.username,
      address: env.OAUTH_ENABLED ? this.props.initialValues.fromAddress : this.state.address,
