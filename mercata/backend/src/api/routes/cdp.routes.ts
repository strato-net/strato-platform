...
/**
 * @openapi
 * /cdp/protocol-revenue:
 *   get:
 *     summary: Get total protocol revenue from CDP fees
 *     tags: [CDP]
 *     security:
 *       - BearerAuth: []
 *     description: |
 *       Returns the total protocol revenue collected from CDP stability fees.
 *       This is the sum of all toCollector values from FeesRouted events.
 *     responses:
 *       200:
 ...
 *                 totalRevenue:
 *                   type: string
 *                   description: Total protocol revenue in wei (18 decimals)
 *                 revenueByPeriod:
 *                   type: object
 *                   description: Revenue breakdown by time period with asset details
 *                   properties:
 *                     daily:
 *                       type: object
 *                       properties:
 *                         total:
 *                           type: string
 *                           description: Total revenue from last 24 hours in wei
 *                         byAsset:
 *                           type: array
 *                           items:
 *                             type: object
 ...
 *                         total:
 *                           type: string
 *                           description: Total revenue from last 7 days in wei
 *                         byAsset:
 *                           type: array
 *                           items:
 *                             type: object
 ...
 *                         total:
 *                           type: string
 *                           description: Total revenue from last 30 days in wei
 *                         byAsset:
 *                           type: array
 *                           items:
 *                             type: object
 ...
 *                         total:
 *                           type: string
 *                           description: Revenue year-to-date in wei
 *                         byAsset:
 *                           type: array
 *                           items:
 *                             type: object
 ...
 *                         total:
 *                           type: string
 *                           description: All-time revenue in wei
 *                         byAsset:
 *                           type: array
 *                           items:
 *                             type: object
 ...
 *                                 type: string
 */
router.get("/protocol-revenue", authHandler.authorizeRequest(), CDPController.getProtocolRevenue);
