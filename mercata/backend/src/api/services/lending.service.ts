...
export const liquidityAndBalance = async (
  ...
  try {
    ...
    console.warn("Failed to load staked mToken balance, using wallet-only balance:", error);
    stakedMTokenBalance = "0";
  }
  ...
  const userMTokenBalanceTotal = BigInt(mTokenBalance) + BigInt(stakedMTokenBalance);
