...
import { LayoutDashboard, Wallet, Book, ArrowRightLeft, Send, Shield, X, Activity, BarChart3, Droplets, Download, Coins, UserPlus, Vault, CreditCard } from 'lucide-react';
...
const MobileSidebar = ({ isOpen, onClose }: MobileSidebarProps) => {
  ...
  const allNavItems = [
    ...
    { icon: <CreditCard size={20} />, label: 'Stripe Payment', path: '/dashboard/stripe-payment' },
