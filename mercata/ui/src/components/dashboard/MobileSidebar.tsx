...
import { LayoutDashboard, Wallet, Book, ArrowRightLeft, Send, Shield, X, Activity, BarChart3, Droplets, Download, Coins, Vault, HandCoins, ArrowDownToLine, ShieldCheck } from 'lucide-react';
  ...
  const navCategories: MobileNavCategory[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: <ShieldCheck size={20} />, label: 'Stake STRATO', path: '/dashboard/earn-staking' },
