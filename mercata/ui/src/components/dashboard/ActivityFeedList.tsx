    ...
    <Card key={event.id} className="mb-3 sm:mb-4 hover:shadow-md transition-shadow">
      ...
      <CardContent className="px-3 sm:px-6 pt-3">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <code className="text-xs bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded cursor-help">
          ...
          <div className="space-y-2">
            <div className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Event Attributes:</div>
