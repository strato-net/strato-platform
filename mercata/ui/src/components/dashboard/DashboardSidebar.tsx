...
import { LayoutDashboard, Wallet, ArrowLeft, ArrowRight, Book, ArrowRightLeft, Send, Shield, Activity, BarChart3, Coins, Droplets, Download, ScanQrCode, UserPlus } from 'lucide-react';
