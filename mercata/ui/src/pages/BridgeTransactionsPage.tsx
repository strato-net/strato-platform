...
import { ArrowDownLeft, ArrowUpRight, Copy, ExternalLink, Clock, CheckCircle2, AlertCircle, ArrowLeft } from 'lucide-react';
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h1 className="text-2xl font-semibold text-gray-900">Bridge History</h1>
                </div>
