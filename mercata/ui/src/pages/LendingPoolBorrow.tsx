...
const LendingPoolBorrow = () => {
  ...
  useEffect(() => {
    document.title = "Lending Pool Borrow | STRATO Mercata";
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="transition-all duration-300 md:pl-64" style={{ paddingLeft: 'var(--sidebar-width, 0rem)' }}>
        <DashboardHeader title="Lending Pool Borrow" onMenuClick={() => setIsMobileSidebarOpen(true)} />
...
export default LendingPoolBorrow;
