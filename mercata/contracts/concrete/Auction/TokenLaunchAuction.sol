...
contract record TokenLaunchAuction is Ownable {
    ...
    event RefundWithdrawn(uint bidId, address bidder, uint amount);
    ...
    function initialize(
        ...
        auctionDurationSeconds = 604800;
        closeBufferSeconds = 3600;
        tier1WindowSeconds = 172800;
        tier2WindowSeconds = 345600;
        tier2VestingSeconds = 2592000;
        tier3VestingSeconds = 7776000;
    ...
    function withdrawCanceled(uint bidId) external {
        ...
        emit RefundWithdrawn(bidId, msg.sender, bid.budgetUSDST);
    }
    ...
    function withdrawRefund(uint bidId) external {
        ...
        emit RefundWithdrawn(bidId, msg.sender, bid.refundUSDST);
    }
