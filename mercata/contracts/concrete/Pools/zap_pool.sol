...
contract record Pool is Ownable {
    ...
    function _internalSwapForZap(
        ...
        // move output tokens from pool reserve to pool (no external transfer)
        // since tokens are already in pool, we just leave them; reserves update naturally
        // accounting happens via balanceOf checks later
    }
    ...
    function addLiquiditySingleToken(
        ...
        uint256 reserveIn = ERC20(depositToken).balanceOf(address(this)) - amountIn; // reserve before deposit
