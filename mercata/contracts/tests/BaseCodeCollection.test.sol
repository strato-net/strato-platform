...
contract Describe_Mercata {
    ...
    function it_can_verify_a_groth16_proof() {
        ...
        uint[2] a = [5865647092192833837722263729831692480009612304098377726420218129176180742929
                    ,20366463111280734352240361132748182595419053284829456385081983248374069108383
                    ];
        uint[2][2] b = [[19826994083472093963469657197806855628668640663151934606041440443216465299794
                        ,6078631605387293675337724946783357021061701150993293835111925759033069597369
                        ]
                       ,[21390696821980339543912357476695664021537485664648295535390293205392834578201
                        ,8559588435182295128804298046584835228350939537406623873119743802231698305292
                        ]
                       ];
        uint[2] c = [20310755303852604801696554988904975774165164048522814260925549288079465293818
                    ,7982215064972153444563799524213236152374962269003106261974377240101773280648
                    ];
        uint[2] input = [385,5];
    ...
    function property_adds_to_seven(uint a, uint b, uint c, string x) returns (bool) {
        return !(a == 7 || b == 7 || c == 7) || x == "Hello";
    }
}
