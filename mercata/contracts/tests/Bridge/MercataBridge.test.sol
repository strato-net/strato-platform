...
contract Describe_MercataBridge is Authorizable {
    ...
    function it_bridge_can_initiate_deposit_with_usdst_minting() {
        ...
        (,,,,, address stratoToken,,) = bridge.deposits(externalChainId, StringUtils.normalizeHex(txHash));
    ...
    function it_bridge_can_handle_batch_deposits() {
        ...
        (,,,,, address stratoToken1,,) = bridge.deposits(externalChainId, StringUtils.normalizeHex(txHashes[0]));
        (,,,,, address stratoToken2,,) = bridge.deposits(externalChainId, StringUtils.normalizeHex(txHashes[1]));
    ...
    function it_bridge_handles_different_chain_ids() {
        ...
        (BridgeStatus bridgeStatus1,,,,,,,) = bridge.deposits(chainId1, StringUtils.normalizeHex("0x1a2b3c4d5e6f"));
        (BridgeStatus bridgeStatus2,,,,,,,) = bridge.deposits(chainId2, StringUtils.normalizeHex("0xf6e5d4c3b2a1"));
    ...
    function it_bridge_allows_deposit_with_valid_recipient() {
        ...
        (BridgeStatus status,,,,,,,) = bridge.deposits(externalChainId, StringUtils.normalizeHex(txHash));
    ...
    function it_bridge_normalizes_transaction_hashes() {
        ...
        (BridgeStatus status,,,,,,,) = bridge.deposits(externalChainId, StringUtils.normalizeHex("0xabcdef1234"));
    ...
    function it_normalizes_0x_and_non_0x_hashes() {
        ...
        require(StringUtils.normalizeHex(hashWith0x) == StringUtils.normalizeHex(hashWithout0x), "Hash with 0x prefix should be normalized to hash without 0x prefix");
        ...
        (BridgeStatus status,,,,,,,) = bridge.deposits(externalChainId, StringUtils.normalizeHex(hashWith0x));
    ...
    function it_bridge_can_handle_batch_abort_deposits() {
        ...
        (BridgeStatus status1,,,,,,,) = bridge.deposits(externalChainId, StringUtils.normalizeHex(txHash1));
        (BridgeStatus status2,,,,,,,) = bridge.deposits(externalChainId, StringUtils.normalizeHex(txHash2));
    ...
    function it_bridge_deposit_decimal_conversion_works_correctly() {
        ...
        (,,,,,, uint256 recordedStratoAmount,) = bridge.deposits(externalChainId, StringUtils.normalizeHex("0x123"));
        ...
        (,,,,,, uint256 recordedStratoAmount2,) = bridge.deposits(externalChainId, StringUtils.normalizeHex("0x456"));
    ...
    function it_bridge_deposit_same_decimal_conversion_works_correctly() {
        ...
        (,,,,,, uint256 recordedStratoAmount,) = bridge.deposits(externalChainId, StringUtils.normalizeHex("0x789"));
        ...
        (,,,,,, uint256 recordedStratoAmount2,) = bridge.deposits(externalChainId, StringUtils.normalizeHex("0xabc"));
        ...
        (,,,,,, uint256 recordedStratoAmount3,) = bridge.deposits(externalChainId, StringUtils.normalizeHex("0xdef"));
