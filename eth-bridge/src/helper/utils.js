...
const sendEmail = async (baseUrl, notificationUrl, type, userName, token) => {
  ...
  const emailTemplates = {
    firstPurchase: {
      subject: "Big Win! You've Earned 4% Back in STRAT!",
      content: `
        <h1>Congratulations! You've made your first move and it's already paying off.</h1>
        <p>For your first purchase on Mercata Marketplace, we've added 4% of the value back into your account in STRAT. These are your winnings, ready to be redeemed for exclusive items, special offers, and more.</p>
        <h2>What's Next?</h2>
        <ul>
          <li>Keep playing and keep winning – every purchase earns you more STRAT.</li>
    ...
    additionalPurchase: {
      subject: "Your Purchase Earned You More STRAT – Keep Winning!",
      content: `
        <h1>The cards are in your favor!</h1>
        <p>With your latest purchase, you've just stacked up even more STRAT.</p>
        <p>We've credited your account with 2% of your purchase value in STRAT. Every purchase on Mercata Marketplace gets you closer to those exclusive rewards and perks.</p>
        <p>Every time you buy, you're earning more STRAT, bringing you closer to those high-roller rewards.</p>
        <a href="https://${baseUrl}" style="display: inline-block; width: 100%; max-width: 250px; padding: 10px 20px; background-color: #007bff; color: white; text-decoration: none; text-align: center; box-sizing: border-box;">Check Your Winnings – View STRAT Balance</a>
    ...
    sellerReward: {
      subject: "🎉 You've Earned 1% Back in STRAT for Your Sale!",
      content: `
        <h1>Congratulations, you've made a successful sale on Mercata Marketplace!</h1>
        <p>As a reward, we've credited your account with 1% of the sale value in STRAT. These points are our way of saying thanks for being an active part of the Mercata community.</p>
        <h2>What Can You Do with STRAT?</h2>
        <ul>
          <li>Redeem them for exclusive rewards and special offers.</li>
          <li>Save them up for even bigger rewards down the line.</li>
          <li>Use your STRAT to enhance your standing in the Mercata ecosystem.</li>
        </ul>
        ...
        <a href="https://${baseUrl}" style="padding: 10px 20px; background-color: #007bff; color: white; text-decoration: none;">View Your STRAT Balance</a>
        <p>Thanks for being a valued member of the Mercata community. We look forward to seeing your next big sale!</p>
        <p>Best regards,<br>The Mercata Team</p>
      `,
    },
    newRegistration: {
      subject: "Jackpot! You've Just Scored 100 STRATs on Mercata!",
      content: `
