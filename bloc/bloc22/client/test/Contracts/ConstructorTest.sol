...
contract TestBytesDynCons {
  ...
  function TestBytesDynCons(bytes x) {
      storedData = x;
  }
...
contract TestAddressBytesCons {
  string public _tag = "TestAddressCons";
  address public storedData;
  bytes public storedData2;
  function TestAddressBytesCons(address x, bytes y) {
      storedData = x;
      storedData2 = y;
  }
  function get() returns (address retVal) {
...
contract TestLessComplexCons {
  ...
  function TestLessComplexCons(uint _uint, int _int, address _address, bool _bool, string _string,
                           bytes32 _bytes32St, uint[3] _uintArrSt) {
      storedDataUInt = _uint;
      storedDataInt = _int;
      storedDataAddress = _address;
      storedDataBool = _bool;
