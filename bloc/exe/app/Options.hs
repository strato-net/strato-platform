...
defineFlag "bloc20host" ("localhost" :: HostName) "the host name for Bloc v2.0 for the documentation"
defineFlag "bloc20port" (8000 :: Integer) "the port number for Bloc v2.0 for the documentation"
defineFlag "bloc20path" ("/bloc/v2.0" :: FilePath) "the API path for Bloc v2.0 for the documentation"
defineFlag "bloc21host" ("localhost" :: HostName) "the host name for Bloc v2.1 for the documentation"
defineFlag "bloc21port" (8000 :: Integer) "the port number for Bloc v2.1 for the documentation"
