  ...
  for (const chain of chains) {
    ...
    const chainSummary = {
      ...
      expectedServiceEnvironment: [
        ...
        `CHAIN_${chain.chainId}_VAULT_AUTHORIZATION_SIGNER_ADDRESSES`,
        `CHAIN_${chain.chainId}_EXTERNAL_BRIDGE_VERIFIER_URLS`,
        `CHAIN_${chain.chainId}_EXTERNAL_BRIDGE_VERIFIER_API_TOKENS`,
        `CHAIN_${chain.chainId}_EXTERNAL_BRIDGE_EXECUTOR_ADDRESS`,
        `CHAIN_${chain.chainId}_EXTERNAL_BRIDGE_EXECUTOR_KMS_KEY_ID`,
        `CHAIN_${chain.chainId}_EXTERNAL_BRIDGE_EXECUTOR_KMS_REGION`,
      ],
      proposals: [],
