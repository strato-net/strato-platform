...
// Frozen copy of the deployed StratoNativeRepresentationBridge, kept only so
// the upgrade plugin can diff storage layouts against it. Not deployed.
...
import "../../bridge/StratoNativeRepresentationToken.sol";
...
contract StratoNativeRepresentationBridgeLegacyV1 is
    Initializable,
