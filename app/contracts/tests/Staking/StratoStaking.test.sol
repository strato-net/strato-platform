...
// currently ships. The V2 contract lives in StratoStakingV2.sol until the
...
contract Describe_StratoStaking {
    ...
    // ── DISABLED: tests for the V2 staking contract ──────────────────────────
    // These exercise StratoStakingV2 features that the V1 (18.4) contract in
    // BaseCodeCollection does not have: block reward / proposal accounting,
    // the governance-backed validator set, USDST fee settlement, jailing,
    // self-bond floors, exits and the mutation budget.
    //
    // Bodies are commented out as well as renamed: a disabled test still has to
    // compile, and these call functions V1 does not declare.
    //
    // To restore when V2 moves back into the collection, take the full V2 file:
    //     git show 65bf9628f2:app/contracts/tests/Staking/StratoStaking.test.sol
    // ─────────────────────────────────────────────────────────────────────────

    function xit_activates_eligible_validators_explicitly_and_tracks_weight() public {
    ...
    function xit_republishes_stakes_to_a_governance_that_knows_nothing() public {
        // _bondBoth();
    ...
    function xit_removes_and_readds_validators_around_the_threshold() public {
        // _bondBoth();
    ...
    function xit_enforces_a_self_bond_floor_when_set() public {
    ...
    function xit_never_removes_the_last_validator() public {
    ...
    function xit_requires_a_validator_address_and_swaps_registration_on_change() public {
        // _bondBoth();
    ...
    function xit_reconciles_the_set_when_governance_is_enabled_later() public {
    ...
    function xit_credits_proposer_fees_to_operator_and_delegators() public {
        // _bondBoth();
        // _stake(user1, address(operatorA), 1000e18);
        //
    ...
    function xit_settles_delegator_fees_when_stake_changes() public {
        // _bondBoth();
        // _stake(user1, address(operatorA), 1000e18);
        // setBlockContext(VALIDATOR_A, address(0), address(0), 0);
        // usdst.mint(address(staking), 100e18);
    ...
    function xit_holds_fees_for_unknown_proposers_until_recovered() public {
    ...
    function xit_sets_usdst_on_a_contract_upgraded_in_place() public {
    ...
    function xit_only_lets_the_owner_set_usdst() public {
        // UpgradedInPlaceStaking upgraded = new UpgradedInPlaceStaking(address(this));
        // upgraded.initialize(address(strato), address(usdst), 100, 5000, 1000, 16);
        // upgraded.forgetUsdst();
        //
    ...
    function xit_counts_proposals_and_misses_once_per_block() public {
        // _bondBoth();
        //
    ...
    function xit_jails_after_max_consecutive_misses_and_releases_after_cooldown() public {
        // _bondBoth();
    ...
    function xit_does_not_count_a_miss_without_a_round_change() public {
        // _bondBoth();
    ...
    function xit_process_block_never_reverts_when_governance_rejects() public {
        // _bondBoth();
    ...
    function xit_register_is_permissionless_but_activation_is_gated() public {
    ...
    function xit_fills_the_set_then_evicts_the_lowest_with_margin() public {
    ...
    function xit_reconciles_waiters_by_stake_within_the_mutation_budget() public {
    ...
    function xit_mutation_cap_fails_closed_but_kicks_bypass_it() public {
    ...
    function xit_exits_after_the_notice_period() public {
        // _bondBoth();
    ...
    function xit_enforces_the_unkick_cooldown() public {
        // _bondBoth();
        // registry.removeOperator(address(operatorA));
        // require(staking.status(address(operatorA)) == 3, "Kicked");
    ...
    function xit_caps_inbound_stake_per_operator() public {
        // _selfBond(operatorA, 1000e18);
    ...
    function xit_process_block_is_a_noop_before_initialization() public {
