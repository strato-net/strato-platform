...
export const ACTIVITY_FILTER_CONFIGS: Record<string, FilterConfig> = {
  ...
  "SaveUSDSTVault:Deposit": { type: "single", attribute: "owner", excludeProtocolAddresses: ["owner"] },
  ...
  "MetalForge:MetalMinted": { type: "single", attribute: "buyer", excludeProtocolAddresses: ["buyer"] },
  "YieldVault:Deposit": { type: "single", attribute: "owner", excludeProtocolAddresses: ["owner"] },
