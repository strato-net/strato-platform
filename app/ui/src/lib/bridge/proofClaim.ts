 ...
 *
 * The vault releases on a valid proof regardless of the withdrawal's sequence
 * number, so there is nothing to catch up: a claim never has to wait behind,
 * or submit proofs for, anyone else's earlier withdrawal.
 *
