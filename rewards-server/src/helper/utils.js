...
const sendEmail = async (baseUrl, notificationUrl, type, userName, token) => {
  ...
  const emailTemplates = {
    firstPurchase: {
      subject: "Big Win! You've Earned 4% Back in STRATs!",
      content: `
    ...
    additionalPurchase: {
      subject: "Your Purchase Earned You More STRATs – Keep Winning!",
      content: `
        ...
        <a href="https://${baseUrl}" style="display: inline-block; width: 100%; max-width: 250px; padding: 10px 20px; background-color: #007bff; color: white; text-decoration: none; text-align: center; box-sizing: border-box;">Check Your Winnings – View STRATs Balance</a>
    ...
    sellerReward: {
      subject: "🎉 You've Earned 1% Back in STRATs for Your Sale!",
      content: `
        ...
        <a href="https://${baseUrl}" style="padding: 10px 20px; background-color: #007bff; color: white; text-decoration: none;">View Your STRATs Balance</a>
