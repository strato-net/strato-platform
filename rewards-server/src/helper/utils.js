...
const sendEmail = async (baseUrl, notificationUrl, type, userName, token) => {
  ...
  const emailTemplates = {
    firstPurchase: {
      ...
      content: `
        ...
        <ul>
          ...
          <li>Redeem your USDSTs for high-roller rewards or save them for a bigger payout!</li>
        </ul>
    ...
    newRegistration: {
      subject: "Jackpot! You've Just Scored 100 USDSTs on Mercata!",
      content: `
        <h1>Welcome to the Mercata VIP Lounge!</h1>
        <p>You've hit the jackpot just by joining us! To kickstart your journey, we've credited your account with 100 USDSTs. Consider it your welcome bonus for stepping into the Mercata Marketplace.</p>
        <h2>What Are USDSTs?</h2>
        <ul>
          <li>They're your golden chips, ready to be cashed in for exclusive assets, VIP-only promotions, and more.</li>
        </ul>
        <p>Ready to roll the dice and see what you can win? Log in now and start stacking those USDSTs!</p>
