# Bloc DB Migrations
Everytime a change to the Bloc DB schema is needed, an appropriate migration must be added to the migrations list in Migration.hs. This is due to our public test-net nodes and client nodes that persist Postgres volumes between software releases.
## Adding a migration
