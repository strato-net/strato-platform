...
setup = do
  ...
  let
    testConfig = TestConfig
      ...
      , testTxParams = Just $ TxParams (Just (Gas 10000000000)) (Just (Wei 1)) Nothing Nothing
      , testTxParamsLowNonce = Just $ TxParams (Just (Gas 10000000000)) (Just (Wei 1)) (Just $ Nonce 0) Nothing
