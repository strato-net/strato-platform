...
solidityTypeToSQLType VariableDecl{varType=SVMType.AddressPayable} = Just "text"
solidityTypeToSQLType VariableDecl{varType=SVMType.Account} = Just "text"
solidityTypeToSQLType VariableDecl{varType=SVMType.AccountPayable} = Just "text"
