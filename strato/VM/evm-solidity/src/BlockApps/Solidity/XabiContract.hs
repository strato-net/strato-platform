...
typeToEvmType (SVMType.UnknownLabel x) = Just $ OLDXABI.UnknownLabel (labelToString x)
...
typeToEvmType (SVMType.Mapping x y z _ _) = OLDXABI.Mapping x <$> typeToEvmType y <*> typeToEvmType z
