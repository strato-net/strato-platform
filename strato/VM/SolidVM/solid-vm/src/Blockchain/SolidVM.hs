...
intBuiltin [SString hex] = integerToValue $ parseBaseInt hex 16  -- uint(number)
intBuiltin [SString hex, SInteger 16] = integerToValue $ parseBaseInt hex 16  -- uint(number, 16)
