...
-- Given a SolidString return a codeCollection. This is used in the call functions.
makePayload :: SolidString -> CodeCollection
makePayload input =
  --TODO: This was generated by Co-Pilot, but it is not clear if it is correct.
  case runParser (parseSolidity input) (ParserState "" "") "" input of
...
genericDelegateCallWrapper from to input isRcc
  ...
  result <- case codetype of
    ContractF c -> runTheConstructors c
    FuncF f -> runTheCall f
    StatementF s -> runStatement s
  -- TODO
