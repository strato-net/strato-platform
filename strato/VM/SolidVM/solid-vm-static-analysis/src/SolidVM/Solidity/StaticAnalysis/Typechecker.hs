...
getVarType' "create" ctx = pure $ Function (createFuncArgs ctx) (contractType' ctx) ctx [] []
getVarType' "create2" ctx = pure $ Function (saltCreateArgs ctx) (contractType' ctx) ctx [] []
