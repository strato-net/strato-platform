...
defineFlag "identityServerUrl" ("https://identity.blockapps.net" :: String) "The URL of the identity server"
...
defineFlag "useNetworkIdByDefault" (True :: Bool) "Whether the api should add in the network id to all posted transactions by default"
