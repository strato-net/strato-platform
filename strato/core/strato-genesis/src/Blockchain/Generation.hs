  ...
  let initialAccounts = genesisInfoAccountInfo gi
      ...
      testRootAcct = SolidVMContractWithStorage 0x9999 0
        ...
        [
            ...
            (".country", rlpWrap . BString . BC.pack . fromMaybe "" . subCountry $ testCertSubject),
            (".organization", rlpWrap . BString . BC.pack . subOrg $ testCertSubject),
            (".group", rlpWrap . BString . BC.pack . fromMaybe "" . subUnit $ testCertSubject),
            (".organizationalUnit", rlpWrap . BString . BC.pack . fromMaybe "" . subUnit $ testCertSubject),
