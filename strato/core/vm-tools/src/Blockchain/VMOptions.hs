...
defineFlag "createSnapshots" (True :: Bool) "Whether to create snapshots or not"
defineFlag "snapshotInterval" (100 :: Integer) "The block intervals at which we create snapshots. \
