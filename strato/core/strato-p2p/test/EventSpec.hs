...
data TestContext = TestContext
  { _blocks :: [Block],
    ...
    _prvKey :: PrivateKey,
    _shaBlockDataMap :: Data.Map.Strict.Map Keccak256 BlockData,
    _p2pWorldBestBlock :: WorldBestBlock,
    _bestBlock :: BestBlock,
    _canonicalBlockDataMap :: Data.Map.Strict.Map Integer (Canonical BlockData),
...
instance MonadIO m => Mod.Modifiable [BlockData] (MonadP2PTest m) where
  get _ = use blockHeaders
  put _ = assign blockHeaders

instance MonadIO m => Mod.Accessible [BlockData] (MonadP2PTest m) where
