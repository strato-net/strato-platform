...
defineFlag "stratourl" ("http://strato:3000/eth/v1.2"::String)
    "URL of the Strato server Bloc will connect to"
defineFlag "vaultwrapperurl" ("http://strato:8013/strato/v2.3"::String) --Might need to be http://strato:8013 instead
