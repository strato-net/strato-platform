...
ecPubkeyParseTest = do
  ...
  where
    der = LabeledError.b16Decode "ecPubkeyParseTest"
...
ecPubKeySerializeTest = do
  ...
  where
    der = LabeledError.b16Decode "ecPubKeySerializeTest"
        "03dded4203dac96a7e85f2c374a37ce3e9c9a155a72b64b4551b0bfe779dd44705"
...
pubkeyStorableTest = do
    ...
    assertEqual "public key matches" der dec
  where
    der = LabeledError.b16Decode "pubkeyStorableTest"
        "03dded4203dac96a7e85f2c374a37ce3e9c9a155a72b64b4551b0bfe779dd44705"
...
signatureStorableTest = do
  ...
  where
    cpt = CompactSig
        (toShort $ LabeledError.b16Decode "signatureStorableTest" "f502bfa07af43e7ef265618b0d929a7619ee01d6150e37eb6eaaf2c8bd37fb22")
        (toShort $ LabeledError.b16Decode "signatureStorableTest" "6f0415ab0e9a977afd78b2c26ef39b3952096d319fd4b101c768ad6c132e3045")
...
ecdsaSignatureParseDerTest = do
  ...
  where
    der = LabeledError.b16Decode "ecdsaSignatureParseDerTest"
...
ecdsaSignatureSerializeDerTest = do
  ...
  where
    der = LabeledError.b16Decode "ecdsaSignatureSerializeDerTest"
        "3045022100f502bfa07af43e7ef265618b0d929a7619ee01d6150e37eb6eaaf2c8bd37\
        \fb2202206f0415ab0e9a977afd78b2c26ef39b3952096d319fd4b101c768ad6c132e30\
        \45"
...
ecdsaVerifyTest = do
  ...
  where
    der = LabeledError.b16Decode "ecdsaVerifyTest"
        "3045022100f502bfa07af43e7ef265618b0d929a7619ee01d6150e37eb6eaaf2c8bd37\
        \fb2202206f0415ab0e9a977afd78b2c26ef39b3952096d319fd4b101c768ad6c132e30\
        \45"
    pub = LabeledError.b16Decode "ecdsaVerifyTest"
    ...
    msg = Msg32 $ toShort $ LabeledError.b16Decode "ecdsaVerifyTest"
...
ecdsaSignTest = do
  ...
  where
    msg = Msg32 $ toShort $ LabeledError.b16Decode "ecdsaSignTest"
        "f5cbe7d88182a4b8e400f96b06128921864a18187d114c8ae8541b566c8ace00"
    key = SecKey32 $ toShort $ LabeledError.b16Decode "ecdsaSignTest"
...
ecSecKeyVerifyTest = do
  ...
  where
    key = SecKey32 $ toShort $ LabeledError.b16Decode "ecSecKeyVerifyTest"
        "f65255094d7773ed8dd417badc9fc045c1f80fdc5b2d25172b031ce6933e039a"
...
ecPubkeyCreateTest = do
  ...
  where
    key = SecKey32 $ toShort $ LabeledError.b16Decode "ecPubkeyCreateTest"
        "f65255094d7773ed8dd417badc9fc045c1f80fdc5b2d25172b031ce6933e039a"
    pub = LabeledError.b16Decode "ecPubkeyCreateTest"
        "04dded4203dac96a7e85f2c374a37ce3e9c9a155a72b64b4551b0bfe779dd447051221\
        \3d5ed790522c042dee8e85c4c0ec5f96800b72bc5940c8bc1c5e11e4fcbf"
...
ecSecKeyTweakAddTest = do
  ...
  where
    key = SecKey32 $ toShort $ LabeledError.b16Decode "ecSecKeyTweakAddTest"
        "f65255094d7773ed8dd417badc9fc045c1f80fdc5b2d25172b031ce6933e039a"
    tweak = Tweak32 $ toShort $ LabeledError.b16Decode "ecSecKeyTweakAddTest"
        "f5cbe7d88182a4b8e400f96b06128921864a18187d114c8ae8541b566c8ace00"
    expected = SecKey32 $ toShort $ LabeledError.b16Decode "ecSecKeyTweakAddTest"
...
ecSecKeyTweakMulTest = do
    ...
    assertEqual "tweaked keys match" expected tweaked
  where
    key = SecKey32 $ toShort $ LabeledError.b16Decode "ecSecKeyTweakMulTest"
        "f65255094d7773ed8dd417badc9fc045c1f80fdc5b2d25172b031ce6933e039a"
    tweak = Tweak32 $ toShort $ LabeledError.b16Decode "ecSecKeyTweakMulTest"
        "f5cbe7d88182a4b8e400f96b06128921864a18187d114c8ae8541b566c8ace00"
    expected = SecKey32 $ toShort $ LabeledError.b16Decode "ecSecKeyTweakMulTest"
...
ecPubKeyTweakAddTest = do
    ...
    assertEqual "tweaked keys match" expected tweaked
  where
    pub = LabeledError.b16Decode "ecPubKeyTweakAddTest"
        "04dded4203dac96a7e85f2c374a37ce3e9c9a155a72b64b4551b0bfe779dd447051221\
        \3d5ed790522c042dee8e85c4c0ec5f96800b72bc5940c8bc1c5e11e4fcbf"
    tweak = Tweak32 $ toShort $ LabeledError.b16Decode "ecPubKeyTweakAddTest"
        "f5cbe7d88182a4b8e400f96b06128921864a18187d114c8ae8541b566c8ace00"
    expected = LabeledError.b16Decode "ecPubKeyTweakAddTest"
...
ecPubKeyTweakMulTest = do
    ...
    assertEqual "tweaked keys match" expected tweaked
  where
    pub = LabeledError.b16Decode "ecPubKeyTweakMulTest"
        "04dded4203dac96a7e85f2c374a37ce3e9c9a155a72b64b4551b0bfe779dd447051221\
        \3d5ed790522c042dee8e85c4c0ec5f96800b72bc5940c8bc1c5e11e4fcbf"
    tweak = Tweak32 $ toShort $ LabeledError.b16Decode "ecPubKeyTweakMulTest"
        "f5cbe7d88182a4b8e400f96b06128921864a18187d114c8ae8541b566c8ace00"
    expected = LabeledError.b16Decode "ecPubKeyTweakMulTest"
...
ecPubKeyCombineTest = do
  ...
  where
    parse x pub p = useAsCStringLen pub $ \(d, dl) -> do
        ret <- ecPubKeyParse x p (castPtr d) (fromIntegral dl)
        unless (isSuccess ret) $ error "could not parse public key"
    pub1 = LabeledError.b16Decode "ecPubKeyCombineTest"
        "04dded4203dac96a7e85f2c374a37ce3e9c9a155a72b64b4551b0bfe779dd447051221\
        \3d5ed790522c042dee8e85c4c0ec5f96800b72bc5940c8bc1c5e11e4fcbf"
    pub2 = LabeledError.b16Decode "ecPubKeyCombineTest"
    ...
    pub3 = LabeledError.b16Decode "ecPubKeyCombineTest"
    ...
    expected = LabeledError.b16Decode "ecPubKeyCombineTest"
