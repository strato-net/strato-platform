...
testRootCert = let eCert = bsToCert $ C8.pack $ unlines
                    ["-----BEGIN CERTIFICATE-----"
                    ,"MIIBbzCCAROgAwIBAgIRAN8UEWPK6yH9mVYh4ZVsNfswDAYIKoZIzj0EAwIFADBI"
                    ,"MQ4wDAYDVQQDDAVBZG1pbjESMBAGA1UECgwJQmxvY2tBcHBzMRQwEgYDVQQLDAtF"
                    ,"bmdpbmVlcmluZzEMMAoGA1UEBgwDVVNBMB4XDTIyMTIyMjE3MTUwNFoXDTIzMTIy"
                    ,"MjE3MTUwNFowKTETMBEGA1UEAwwKVHlzb24gUm9zZTESMBAGA1UECgwJQmxvY2tB"
                    ,"cHBzMFYwEAYHKoZIzj0CAQYFK4EEAAoDQgAEKkyq8QGUzpEqQ9sMB17KzzxnsceA"
                    ,"T+95aVXMT2HhINHG6uM9LYEI6t+ryK7sGOTDN0r7Meh/aSnUD81EAjhIfzAMBggq"
                    ,"hkjOPQQDAgUAA0gAMEUCIQDSMP9rnxE99iDSTJXVXn+wWiJIIM+BenZyLfLY4fyD"
                    ,"igIgfNw1xE9qUA9hrzWNd1ZH0M96eBcy0xtG4WkSNXd83JA="
                    ,"-----END CERTIFICATE-----"
                    ,"-----BEGIN CERTIFICATE-----"
                    ,"MIIBjTCCATKgAwIBAgIRAOPPkVoBp/GnwZGR32jcIjwwDAYIKoZIzj0EAwIFADBI"
                    ,"MQ4wDAYDVQQDDAVBZG1pbjESMBAGA1UECgwJQmxvY2tBcHBzMRQwEgYDVQQLDAtF"
