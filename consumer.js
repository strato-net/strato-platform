var Promise = require('bluebird'),
 ...
 chalk = require('chalk'),
 _ = require('lodash/fp'),
 __ = require('lodash'), // not pretty but how else to use __.map((k,v) => {...}) ?
...
// function start() {
//   return function(scope) {
//     // scope.consumer.addTopics([{ topic: 't1', offset: 10 }], function (err, added) {
//     // }, true);
//     // scope.consumer.on('message', function (m) {
